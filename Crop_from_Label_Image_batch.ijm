...
// Input: A folder of images (can be hyperstacks), 
//		and a folder of corresponding label images (e.g. generated by cellpose)
//
// Output: A cropped image or stack (matching the dimensionality of input) 
//		corresponding to the bounding box of each label 
//		(except for labels touching the border, and labels below a minimum size), 
//		with the area outside the label cleared to black (0); 
//		a snapshot of the ROI locations;
//		an ROI set;
//		and a log.

// Note: This may still include some cells on the edges, 
// if images have any black borders before segmentation
...
//   The label image must have the same name as 
//		the input image (minus extension), followed by the suffix provided.
...
// collect total number of files processed
